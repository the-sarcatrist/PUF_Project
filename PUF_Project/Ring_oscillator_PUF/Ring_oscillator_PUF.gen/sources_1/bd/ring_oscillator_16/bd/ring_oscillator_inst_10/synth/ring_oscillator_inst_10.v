...
(* CORE_GENERATION_INFO = "ring_oscillator_inst_10,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ring_oscillator_inst_10,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=D_/Vivado/PUF_Project/Ring_oscillator_PUF/Ring_oscillator_PUF.srcs/sources_1/bd/ring_oscillator/ring_oscillator.bd,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ring_oscillator_inst_10.hwdef" *) 
