...
//Date        : Wed Sep 13 14:55:34 2023
//Host        : The-Sarcatrist-Laptop running 64-bit major release  (build 9200)
//Command     : generate_target ring_oscillator_inst_11.bd
//Design      : ring_oscillator_inst_11
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ring_oscillator_inst_11,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ring_oscillator_inst_11,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=D_/Vivado/PUF_Project/Ring_oscillator_PUF/Ring_oscillator_PUF.srcs/sources_1/bd/ring_oscillator/ring_oscillator.bd,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ring_oscillator_inst_11.hwdef" *) 
module ring_oscillator_inst_11
   (IP1,
    OP1);
  input [0:0]IP1;
  output [0:0]OP1;
  ...
  ring_oscillator_inst_11_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(util_vector_logic_4_Res),
        .Res(util_vector_logic_0_Res));
  ring_oscillator_inst_11_util_vector_logic_1_0 util_vector_logic_1
